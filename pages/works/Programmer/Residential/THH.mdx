...
- Programming control systems using crestron.

### Closure (Continuous)

- Performing after-sale on-site maintenance and remote troubleshooting services. Training the user how to use the system.
